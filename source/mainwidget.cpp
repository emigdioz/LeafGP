	...
	ui(new Ui::MainWidget)
{
	...
	connect(this, SIGNAL(requestPauseGP(bool)), workerAlgorithm, SLOT(requestedPause(bool)), Qt::DirectConnection);
	connect(this, SIGNAL(requestStopGP(bool)), workerAlgorithm, SLOT(requestedStop(bool)),Qt::DirectConnection);
	timerGP = new QTimer();
